...
class Visualizer:
    ...
    def update(self, verts, data, f, lmn, defLData):
        ...
        self.defP.plot(self.t_array[:self.t], (self.defLData[1]), label='a', color='r')
        self.defP.plot(self.t_array[:self.t], (self.defLData[0]), label='e', color='g')
        self.defP.plot(self.t_array[:self.t], (self.defLData[2]), label='r', color='b')
